...
\marginnote{More accurately, we want to balance the \emph{standard errors}; here,
I'm assuming the noise is the same for both the treatment and the effect. If the
treatment happened to increase variability, we might actually want to put more
samples in the treatment group, in order to deal with this increase.}
